...
class New extends Component{
    ...
    render(){
        return(
            <form id="new-post" onSubmit={this.handleSumbit}>
                <input type="file" onChange={this.handleImageChance} />

                <input type="text" name="author" placeholder="Autor do post" onChance={this.handleChange} value={this.state.author} />
                ...
                <input type="text" name="hashtags" placeholder="hashtags do post" onChance={this.handleChange} value={this.state.hashtags} />
